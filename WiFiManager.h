...
const char HTTP_SAVED[] PROGMEM           = "<div class=\"msg\"><strong>Credentials Saved</strong><br>Trying to connect Notus to network.<br>Give it 30 seconds or so and check on the <a href=\"/\">main page</a> how it went. It can take as long as minute for the web server to restart.</div><br/>";
const char HTTP_PORTAL_EXIT[] PROGMEM     = "<form action=\"/close\" method=\"get\"><button class=\"btn\">Exit Portal</button></form><br/>";
